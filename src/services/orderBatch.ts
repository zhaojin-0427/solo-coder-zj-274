...
export function createOrder(params: CreateOrderParams): CustomerOrder {
...
export function createOrderItem(params: CreateOrderItemParams): OrderPatternItem {
  return {
    id: generateId(),
...
export function createBatch(params: CreateBatchParams): ProductionBatch {
  return {
    id: generateId(),
    name: params.name,
